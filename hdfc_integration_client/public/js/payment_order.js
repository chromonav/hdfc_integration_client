frappe.ui.form.on('Payment Order', {
		...
		if (frm.doc.docstatus == 0) {
			frm.add_custom_button(__('Payment Request'), function() {
				...
				erpnext.utils.map_current_doc({
					method: "hdfc_integration_client.hdfc_integration_client.doc_events.payment_request.make_payment_order",
			...
			// 	frm.trigger("remove_row_if_empty");
			// 	erpnext.utils.map_current_doc({
			// 		method: "hdfc_integration_client.hdfc_integration_client.doc_events.purchase_invoice.make_payment_order",
	...
	update_status: function(frm) {
		...
		frappe.call({
			method: "hdfc_integration_client.hdfc_integration_client.doc_events.payment_order.modify_approval_status",
			args: {
