...
def get_party_summary(references, company_bank_account):
	...
	# (party_type, party, bank_account, account, state, cost_center, project)

	summary = {}
	for ref in references:
		ref = frappe._dict(ref)
		if (ref.party_type, ref.party, ref.bank_account, ref.account, ref.state, ref.cost_center, ref.project, ref.tax_withholding_category, ref.reference_doctype) in summary:
			summary[(ref.party_type, ref.party, ref.bank_account, ref.account, ref.state, ref.cost_center, ref.project, ref.tax_withholding_category, ref.reference_doctype)] += ref.amount
		else:
			summary[(ref.party_type, ref.party, ref.bank_account, ref.account, ref.state, ref.cost_center, ref.project, ref.tax_withholding_category, ref.reference_doctype)] = ref.amount

	result = []
	for k, v in summary.items():
		party_type, party, bank_account, account, state, cost_center, project, tax_withholding_category, reference_doctype = k
		summary_line_item = {}
